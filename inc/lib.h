...
int 	sys_get_mac_address(void *mac_addr);
unsigned int sys_time_msec(void);

// This must be inlined.  Exercise for reader: why?
int 	sys_env_assign_priority(int priority_number);
...
int	sys_transmit_packet(char *packet, int size);
int	sys_recieve_packet(char *packet, int *size);
